...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "*,\n*:before,\n*:after {\n  font-family: Neue Helvetica, helvetica, sans-serif;\n}\n\nbody {\n  margin: 0;\n}\n\nbody::-webkit-scrollbar {\n  width: 10px;\n}\n\nbody::-webkit-scrollbar-track {\n  background-color: black;\n}\n\nbody::-webkit-scrollbar-thumb {\n  background: rgba(255, 255, 255, 0.4);\n  border-radius: 5px;\n}\n\nbody::-webkit-scrollbar-thumb:hover {\n  background: #555;\n}\n\nh1,\nh2 {\n  text-transform: uppercase;\n  text-align: center;\n}\n\n.hidden,\n.login-required {\n  display: none !important;\n}\n\n.minimized {\n  transform: scaleY(0);\n}\n\n.clear {\n  border-color: transparent !important;\n  color: transparent !important;\n  background: transparent !important;\n  opacity: 0;\n}\n", "",{"version":3,"sources":["webpack://./src/css/styles.css"],"names":[],"mappings":"AAQA;;;EAGE,kDAAkD;AACpD;;AAEA;EACE,SAAS;AACX;;AAEA;EACE,WAAW;AACb;;AAEA;EACE,uBAAuB;AACzB;;AAEA;EACE,oCAAoC;EACpC,kBAAkB;AACpB;;AAEA;EACE,gBAAgB;AAClB;;AAEA;;EAEE,yBAAyB;EACzB,kBAAkB;AACpB;;AAEA;;EAEE,wBAAwB;AAC1B;;AAEA;EACE,oBAAoB;AACtB;;AAEA;EACE,oCAAoC;EACpC,6BAA6B;EAC7B,kCAAkC;EAClC,UAAU;AACZ","sourcesContent":["@import 'buttons';\n@import 'content';\n@import 'footer';\n@import 'header';\n@import 'main';\n@import 'menus';\n@import 'variables';\n\n*,\n*:before,\n*:after {\n  font-family: Neue Helvetica, helvetica, sans-serif;\n}\n\nbody {\n  margin: 0;\n}\n\nbody::-webkit-scrollbar {\n  width: 10px;\n}\n\nbody::-webkit-scrollbar-track {\n  background-color: black;\n}\n\nbody::-webkit-scrollbar-thumb {\n  background: rgba(255, 255, 255, 0.4);\n  border-radius: 5px;\n}\n\nbody::-webkit-scrollbar-thumb:hover {\n  background: #555;\n}\n\nh1,\nh2 {\n  text-transform: uppercase;\n  text-align: center;\n}\n\n.hidden,\n.login-required {\n  display: none !important;\n}\n\n.minimized {\n  transform: scaleY(0);\n}\n\n.clear {\n  border-color: transparent !important;\n  color: transparent !important;\n  background: transparent !important;\n  opacity: 0;\n}\n"],"sourceRoot":""}]);
// Exports
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_cssWithMappingToString_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, "button:hover {\n  cursor: pointer;\n  pointer-events: auto;\n}\n\nbutton:disabled {\n  cursor: default;\n  pointer-events: none;\n}\n\nbutton.close {\n  background: transparent;\n  font-weight: 700;\n  font-size: 0.8em;\n  text-transform: uppercase;\n  color: black;\n  border: none;\n  position: absolute;\n}\n\nbutton.close-menu-btn {\n  color: white;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: 1em;\n  justify-content: center;\n  top: calc(100% + 2.1em);\n  right: 0;\n  left: 0;\n\n  p {\n    margin: 0;\n    color: black;\n    z-index: 3;\n  }\n}\n\nbutton.standard {\n  border: 2px solid black;\n  background: #fff;\n  color: #000;\n  padding: 12px 20px;\n  text-transform: uppercase;\n  text-wrap: nowrap;\n  font-size: 0.75rem;\n  font-style: normal;\n  font-weight: 700;\n  transition: filter 0.25s ease-in-out;\n\n  &:hover:enabled {\n    border: 2px solid black;\n    filter: invert(1);\n  }\n\n  &:disabled {\n    background: gray;\n  }\n}\n", "",{"version":3,"sources":["webpack://./src/css/buttons.css"],"names":[],"mappings":"AAAA;EACE,eAAe;EACf,oBAAoB;AACtB;;AAEA;EACE,eAAe;EACf,oBAAoB;AACtB;;AAEA;EACE,uBAAuB;EACvB,gBAAgB;EAChB,gBAAgB;EAChB,yBAAyB;EACzB,YAAY;EACZ,YAAY;EACZ,kBAAkB;AACpB;;AAEA;EACE,YAAY;EACZ,aAAa;EACb,sBAAsB;EACtB,mBAAmB;EACnB,QAAQ;EACR,uBAAuB;EACvB,uBAAuB;EACvB,QAAQ;EACR,OAAO;;EAEP;IACE,SAAS;IACT,YAAY;IACZ,UAAU;EACZ;AACF;;AAEA;EACE,uBAAuB;EACvB,gBAAgB;EAChB,WAAW;EACX,kBAAkB;EAClB,yBAAyB;EACzB,iBAAiB;EACjB,kBAAkB;EAClB,kBAAkB;EAClB,gBAAgB;EAChB,oCAAoC;;EAEpC;IACE,uBAAuB;IACvB,iBAAiB;EACnB;;EAEA;IACE,gBAAgB;EAClB;AACF","sourcesContent":["button:hover {\n  cursor: pointer;\n  pointer-events: auto;\n}\n\nbutton:disabled {\n  cursor: default;\n  pointer-events: none;\n}\n\nbutton.close {\n  background: transparent;\n  font-weight: 700;\n  font-size: 0.8em;\n  text-transform: uppercase;\n  color: black;\n  border: none;\n  position: absolute;\n}\n\nbutton.close-menu-btn {\n  color: white;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  gap: 1em;\n  justify-content: center;\n  top: calc(100% + 2.1em);\n  right: 0;\n  left: 0;\n\n  p {\n    margin: 0;\n    color: black;\n    z-index: 3;\n  }\n}\n\nbutton.standard {\n  border: 2px solid black;\n  background: #fff;\n  color: #000;\n  padding: 12px 20px;\n  text-transform: uppercase;\n  text-wrap: nowrap;\n  font-size: 0.75rem;\n  font-style: normal;\n  font-weight: 700;\n  transition: filter 0.25s ease-in-out;\n\n  &:hover:enabled {\n    border: 2px solid black;\n    filter: invert(1);\n  }\n\n  &:disabled {\n    background: gray;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_cssWithMappingToString_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, "#menu-content {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  padding: 2rem;\n  width: calc(100% - 4rem);\n  overflow: hidden;\n\n  h3 {\n    margin: 0;\n    font-size: 1.2rem;\n    font-weight: 400;\n    letter-spacing: 0.3rem;\n    line-height: 1.4;\n    text-align: center;\n    text-transform: uppercase;\n  }\n\n  .room-cards-container {\n    display: flex;\n    align-items: center;\n    justify-content: space-around;\n    flex-wrap: wrap;\n    overflow-y: auto;\n    gap: 2rem;\n    padding: 1rem;\n\n    .card {\n      height: 11rem;\n      aspect-ratio: 6 / 4;\n      overflow: hidden;\n      border-radius: 3px;\n      box-shadow: 0px 3px 15px rgba(0, 0, 0, 0.2);\n      display: flex;\n      position: relative;\n\n      h4 {\n        background: black;\n        color: white;\n        text-align: center;\n        margin: 0;\n        padding-top: 10%;\n        min-width: 2rem;\n      }\n\n      .room-card-info {\n        display: flex;\n        gap: 0.5rem;\n        padding: 0.5rem;\n\n        ul {\n          display: flex;\n          flex-direction: column;\n          justify-content: center;\n          margin: 0;\n          padding: 0;\n          text-align: right;\n        }\n\n        ul:first-child {\n          border-right: 2px solid black;\n          padding-right: 0.25rem;\n        }\n\n        ul:last-child {\n          text-align: left;\n        }\n\n        li {\n          text-wrap: nowrap;\n          text-transform: capitalize;\n          list-style-type: none;\n          margin: 0.25rem;\n        }\n      }\n\n      .booking-btn {\n        height: 20%;\n        width: 50%;\n        display: flex;\n        align-items: flex-end;\n        justify-content: flex-end;\n        gap: 0.2rem;\n        border: 0;\n        position: absolute;\n        right: 5%;\n        bottom: 5%;\n        border: none;\n        background-color: rgba(0, 0, 0, 0);\n        padding: 0;\n        transition: all 0.25s ease-in-out;\n\n        span {\n          background-color: black;\n          color: white;\n          padding: 0.25rem;\n          border-radius: 0.1rem;\n          transition: transform 0.35s ease-in-out;\n          transform: scale(0, 0);\n          transform-origin: bottom right;\n        }\n\n        .booking-cal-icon {\n          height: 100%;\n          width: auto;\n          padding: 0;\n\n          transition: all 0.25s ease-in-out;\n          transform-origin: right;\n        }\n\n        .dynamic {\n          fill: black;\n        }\n      }\n\n      .booking-btn:hover {\n        cursor: pointer;\n        transform: scale(1.05) translate(-3%, -1%);\n\n        span {\n          transform: scale(1);\n        }\n\n        .booking-cal-icon {\n          background-color: rgba(0, 0, 0, 0.04);\n        }\n\n        .dynamic {\n          fill: green;\n        }\n      }\n    }\n  }\n\n  #bookings-lists {\n    min-width: 80%;\n    overflow-y: auto;\n\n    h4 {\n      text-transform: capitalize;\n    }\n\n    ul {\n      display: flex;\n      flex-direction: column;\n      align-items: center;\n    }\n\n    li > span {\n      display: flex;\n      gap: 1rem;\n\n      .booking-date {\n        width: 10rem;\n      }\n\n      .booking-room {\n        width: 6rem;\n      }\n\n      .booking-price {\n        width: 7rem;\n      }\n    }\n  }\n}\n", "",{"version":3,"sources":["webpack://./src/css/content.css"],"names":[],"mappings":"AAAA;EACE,aAAa;EACb,sBAAsB;EACtB,mBAAmB;EACnB,aAAa;EACb,wBAAwB;EACxB,gBAAgB;;EAEhB;IACE,SAAS;IACT,iBAAiB;IACjB,gBAAgB;IAChB,sBAAsB;IACtB,gBAAgB;IAChB,kBAAkB;IAClB,yBAAyB;EAC3B;;EAEA;IACE,aAAa;IACb,mBAAmB;IACnB,6BAA6B;IAC7B,eAAe;IACf,gBAAgB;IAChB,SAAS;IACT,aAAa;;IAEb;MACE,aAAa;MACb,mBAAmB;MACnB,gBAAgB;MAChB,kBAAkB;MAClB,2CAA2C;MAC3C,aAAa;MACb,kBAAkB;;MAElB;QACE,iBAAiB;QACjB,YAAY;QACZ,kBAAkB;QAClB,SAAS;QACT,gBAAgB;QAChB,eAAe;MACjB;;MAEA;QACE,aAAa;QACb,WAAW;QACX,eAAe;;QAEf;UACE,aAAa;UACb,sBAAsB;UACtB,uBAAuB;UACvB,SAAS;UACT,UAAU;UACV,iBAAiB;QACnB;;QAEA;UACE,6BAA6B;UAC7B,sBAAsB;QACxB;;QAEA;UACE,gBAAgB;QAClB;;QAEA;UACE,iBAAiB;UACjB,0BAA0B;UAC1B,qBAAqB;UACrB,eAAe;QACjB;MACF;;MAEA;QACE,WAAW;QACX,UAAU;QACV,aAAa;QACb,qBAAqB;QACrB,yBAAyB;QACzB,WAAW;QACX,SAAS;QACT,kBAAkB;QAClB,SAAS;QACT,UAAU;QACV,YAAY;QACZ,kCAAkC;QAClC,UAAU;QACV,iCAAiC;;QAEjC;UACE,uBAAuB;UACvB,YAAY;UACZ,gBAAgB;UAChB,qBAAqB;UACrB,uCAAuC;UACvC,sBAAsB;UACtB,8BAA8B;QAChC;;QAEA;UACE,YAAY;UACZ,WAAW;UACX,UAAU;;UAEV,iCAAiC;UACjC,uBAAuB;QACzB;;QAEA;UACE,WAAW;QACb;MACF;;MAEA;QACE,eAAe;QACf,0CAA0C;;QAE1C;UACE,mBAAmB;QACrB;;QAEA;UACE,qCAAqC;QACvC;;QAEA;UACE,WAAW;QACb;MACF;IACF;EACF;;EAEA;IACE,cAAc;IACd,gBAAgB;;IAEhB;MACE,0BAA0B;IAC5B;;IAEA;MACE,aAAa;MACb,sBAAsB;MACtB,mBAAmB;IACrB;;IAEA;MACE,aAAa;MACb,SAAS;;MAET;QACE,YAAY;MACd;;MAEA;QACE,WAAW;MACb;;MAEA;QACE,WAAW;MACb;IACF;EACF;AACF","sourcesContent":["#menu-content {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  padding: 2rem;\n  width: calc(100% - 4rem);\n  overflow: hidden;\n\n  h3 {\n    margin: 0;\n    font-size: 1.2rem;\n    font-weight: 400;\n    letter-spacing: 0.3rem;\n    line-height: 1.4;\n    text-align: center;\n    text-transform: uppercase;\n  }\n\n  .room-cards-container {\n    display: flex;\n    align-items: center;\n    justify-content: space-around;\n    flex-wrap: wrap;\n    overflow-y: auto;\n    gap: 2rem;\n    padding: 1rem;\n\n    .card {\n      height: 11rem;\n      aspect-ratio: 6 / 4;\n      overflow: hidden;\n      border-radius: 3px;\n      box-shadow: 0px 3px 15px rgba(0, 0, 0, 0.2);\n      display: flex;\n      position: relative;\n\n      h4 {\n        background: black;\n        color: white;\n        text-align: center;\n        margin: 0;\n        padding-top: 10%;\n        min-width: 2rem;\n      }\n\n      .room-card-info {\n        display: flex;\n        gap: 0.5rem;\n        padding: 0.5rem;\n\n        ul {\n          display: flex;\n          flex-direction: column;\n          justify-content: center;\n          margin: 0;\n          padding: 0;\n          text-align: right;\n        }\n\n        ul:first-child {\n          border-right: 2px solid black;\n          padding-right: 0.25rem;\n        }\n\n        ul:last-child {\n          text-align: left;\n        }\n\n        li {\n          text-wrap: nowrap;\n          text-transform: capitalize;\n          list-style-type: none;\n          margin: 0.25rem;\n        }\n      }\n\n      .booking-btn {\n        height: 20%;\n        width: 50%;\n        display: flex;\n        align-items: flex-end;\n        justify-content: flex-end;\n        gap: 0.2rem;\n        border: 0;\n        position: absolute;\n        right: 5%;\n        bottom: 5%;\n        border: none;\n        background-color: rgba(0, 0, 0, 0);\n        padding: 0;\n        transition: all 0.25s ease-in-out;\n\n        span {\n          background-color: black;\n          color: white;\n          padding: 0.25rem;\n          border-radius: 0.1rem;\n          transition: transform 0.35s ease-in-out;\n          transform: scale(0, 0);\n          transform-origin: bottom right;\n        }\n\n        .booking-cal-icon {\n          height: 100%;\n          width: auto;\n          padding: 0;\n\n          transition: all 0.25s ease-in-out;\n          transform-origin: right;\n        }\n\n        .dynamic {\n          fill: black;\n        }\n      }\n\n      .booking-btn:hover {\n        cursor: pointer;\n        transform: scale(1.05) translate(-3%, -1%);\n\n        span {\n          transform: scale(1);\n        }\n\n        .booking-cal-icon {\n          background-color: rgba(0, 0, 0, 0.04);\n        }\n\n        .dynamic {\n          fill: green;\n        }\n      }\n    }\n  }\n\n  #bookings-lists {\n    min-width: 80%;\n    overflow-y: auto;\n\n    h4 {\n      text-transform: capitalize;\n    }\n\n    ul {\n      display: flex;\n      flex-direction: column;\n      align-items: center;\n    }\n\n    li > span {\n      display: flex;\n      gap: 1rem;\n\n      .booking-date {\n        width: 10rem;\n      }\n\n      .booking-room {\n        width: 6rem;\n      }\n\n      .booking-price {\n        width: 7rem;\n      }\n    }\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_cssWithMappingToString_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, "main {\n  background: white;\n  color: black;\n  min-height: 80vh;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n\n  h2 {\n    width: 100%;\n    background: black;\n    color: white;\n    margin: 0;\n    padding: 3rem 0;\n    font-size: 1.5rem;\n    font-style: normal;\n    font-weight: 200;\n    letter-spacing: 0.16em;\n    line-height: 1.3em;\n    text-transform: uppercase;\n  }\n\n  > div {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    flex-wrap: wrap;\n    padding: 7rem 1rem;\n    gap: 2rem;\n  }\n\n  article {\n    width: 300px;\n    height: 550px;\n    display: flex;\n    flex-direction: column;\n    align-items: flex-start;\n\n    figure {\n      margin: 0;\n      width: 100%;\n      height: 75%;\n\n      img {\n        width: 100%;\n        max-height: 100%;\n        object-fit: cover;\n      }\n    }\n\n    h3 {\n      font-size: 0.9rem;\n      font-style: normal;\n      font-weight: 700;\n      letter-spacing: 0.25rem;\n      line-height: 1.3rem;\n      text-transform: uppercase;\n      margin: 1rem 0 0.25rem 0;\n    }\n\n    p {\n      font-size: .9rem;\n      font-style: normal;\n      font-weight: 200;\n      etter-spacing: .03rem;\n      line-height: 1.7rem;\n      margin: 0;\n    }\n\n    button {\n      border: none;\n      background: transparent;\n      color: #ba1818;\n      padding: 0;\n      font: inherit;\n    }\n  }\n\n  section {\n    display: flex;\n    flex-direction: column;\n    gap: 2rem;\n  }\n\n  section article {\n    height: 270px;\n  }\n\n  a {\n    text-decoration: none;\n    color: #ba1818;\n  }\n}\n", "",{"version":3,"sources":["webpack://./src/css/main.css"],"names":[],"mappings":"AAAA;EACE,iBAAiB;EACjB,YAAY;EACZ,gBAAgB;EAChB,aAAa;EACb,sBAAsB;EACtB,mBAAmB;;EAEnB;IACE,WAAW;IACX,iBAAiB;IACjB,YAAY;IACZ,SAAS;IACT,eAAe;IACf,iBAAiB;IACjB,kBAAkB;IAClB,gBAAgB;IAChB,sBAAsB;IACtB,kBAAkB;IAClB,yBAAyB;EAC3B;;EAEA;IACE,aAAa;IACb,mBAAmB;IACnB,uBAAuB;IACvB,eAAe;IACf,kBAAkB;IAClB,SAAS;EACX;;EAEA;IACE,YAAY;IACZ,aAAa;IACb,aAAa;IACb,sBAAsB;IACtB,uBAAuB;;IAEvB;MACE,SAAS;MACT,WAAW;MACX,WAAW;;MAEX;QACE,WAAW;QACX,gBAAgB;QAChB,iBAAiB;MACnB;IACF;;IAEA;MACE,iBAAiB;MACjB,kBAAkB;MAClB,gBAAgB;MAChB,uBAAuB;MACvB,mBAAmB;MACnB,yBAAyB;MACzB,wBAAwB;IAC1B;;IAEA;MACE,gBAAgB;MAChB,kBAAkB;MAClB,gBAAgB;MAChB,qBAAqB;MACrB,mBAAmB;MACnB,SAAS;IACX;;IAEA;MACE,YAAY;MACZ,uBAAuB;MACvB,cAAc;MACd,UAAU;MACV,aAAa;IACf;EACF;;EAEA;IACE,aAAa;IACb,sBAAsB;IACtB,SAAS;EACX;;EAEA;IACE,aAAa;EACf;;EAEA;IACE,qBAAqB;IACrB,cAAc;EAChB;AACF","sourcesContent":["main {\n  background: white;\n  color: black;\n  min-height: 80vh;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n\n  h2 {\n    width: 100%;\n    background: black;\n    color: white;\n    margin: 0;\n    padding: 3rem 0;\n    font-size: 1.5rem;\n    font-style: normal;\n    font-weight: 200;\n    letter-spacing: 0.16em;\n    line-height: 1.3em;\n    text-transform: uppercase;\n  }\n\n  > div {\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    flex-wrap: wrap;\n    padding: 7rem 1rem;\n    gap: 2rem;\n  }\n\n  article {\n    width: 300px;\n    height: 550px;\n    display: flex;\n    flex-direction: column;\n    align-items: flex-start;\n\n    figure {\n      margin: 0;\n      width: 100%;\n      height: 75%;\n\n      img {\n        width: 100%;\n        max-height: 100%;\n        object-fit: cover;\n      }\n    }\n\n    h3 {\n      font-size: 0.9rem;\n      font-style: normal;\n      font-weight: 700;\n      letter-spacing: 0.25rem;\n      line-height: 1.3rem;\n      text-transform: uppercase;\n      margin: 1rem 0 0.25rem 0;\n    }\n\n    p {\n      font-size: .9rem;\n      font-style: normal;\n      font-weight: 200;\n      etter-spacing: .03rem;\n      line-height: 1.7rem;\n      margin: 0;\n    }\n\n    button {\n      border: none;\n      background: transparent;\n      color: #ba1818;\n      padding: 0;\n      font: inherit;\n    }\n  }\n\n  section {\n    display: flex;\n    flex-direction: column;\n    gap: 2rem;\n  }\n\n  section article {\n    height: 270px;\n  }\n\n  a {\n    text-decoration: none;\n    color: #ba1818;\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_cssWithMappingToString_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, "#menu-drawer {\n  background: rgba(227, 232, 235, 0.8);\n  transform-origin: top center;\n  transition: transform 0.5s ease-in-out;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: flex-start;\n  padding: 2.5rem;\n  overflow: hidden;\n}\n\n#menu {\n  min-width: max(300px, 50%);\n  max-width: 1100px;\n  max-height: 100%;\n  background: white;\n  color: black;\n  padding: 1rem;\n  border-radius: 2px;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  position: relative;\n  overflow: hidden;\n\n  header {\n    position: relative;\n    width: 100%;\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n\n    h2 {\n      font-size: 1.5rem;\n      font-weight: 200;\n      letter-spacing: 0.7rem;\n      line-height: 1.4;\n      text-align: center;\n      margin: 1rem 0;\n    }\n  }\n\n  form {\n    position: relative;\n    display: flex;\n    align-content: flex-end;\n    justify-content: center;\n    gap: 2rem;\n    width: 100%;\n\n    [class$='group'] {\n      --default: black;\n      --invalid: red;\n      --isValid-color: black;\n      color: var(--isValid-color);\n      border-bottom: 2px solid var(--isValid-color);\n      width: 100%;\n      max-width: 30rem;\n      display: flex;\n      align-items: flex-end;\n      justify-content: space-between;\n      gap: 0.25rem;\n\n      & > * {\n        margin: 0.25rem;\n      }\n\n      span {\n        margin: 0.25rem 0;\n      }\n\n      label,\n      legend,\n      span {\n        text-wrap: nowrap;\n      }\n\n      legend {\n        font-weight: bold;\n      }\n\n      input {\n        height: 1.5rem;\n        width: 100%;\n        border: none;\n        color: var(--isValid-color);\n      }\n\n      select {\n        border: none;\n      }\n    }\n\n    .radio-input-group {\n      align-items: center;\n      gap: 0;\n\n      label {\n        margin-left: 1em;\n      }\n    }\n\n    fieldset {\n      border: none;\n      padding: 0;\n    }\n\n    button {\n      text-transform: uppercase;\n      text-wrap: nowrap;\n    }\n\n    #login-submit-btn {\n      position: absolute;\n      bottom: 0;\n      right: 0;\n    }\n  }\n\n  #login-form {\n    flex-direction: column;\n    align-items: center;\n    padding: 4rem 0;\n  }\n\n  #check-dates-form {\n    min-width: min(95vw, 1100px);\n  }\n\n  button.close {\n    color: black;\n    font-weight: 700;\n    font-size: 0.8em;\n    position: absolute;\n    top: 0;\n    right: 0;\n    text-transform: uppercase;\n\n    &:hover {\n      cursor: pointer;\n    }\n  }\n}\n", "",{"version":3,"sources":["webpack://./src/css/menus.css"],"names":[],"mappings":"AAAA;EACE,oCAAoC;EACpC,4BAA4B;EAC5B,sCAAsC;EACtC,aAAa;EACb,sBAAsB;EACtB,mBAAmB;EACnB,2BAA2B;EAC3B,eAAe;EACf,gBAAgB;AAClB;;AAEA;EACE,0BAA0B;EAC1B,iBAAiB;EACjB,gBAAgB;EAChB,iBAAiB;EACjB,YAAY;EACZ,aAAa;EACb,kBAAkB;EAClB,aAAa;EACb,sBAAsB;EACtB,mBAAmB;EACnB,kBAAkB;EAClB,gBAAgB;;EAEhB;IACE,kBAAkB;IAClB,WAAW;IACX,aAAa;IACb,sBAAsB;IACtB,mBAAmB;;IAEnB;MACE,iBAAiB;MACjB,gBAAgB;MAChB,sBAAsB;MACtB,gBAAgB;MAChB,kBAAkB;MAClB,cAAc;IAChB;EACF;;EAEA;IACE,kBAAkB;IAClB,aAAa;IACb,uBAAuB;IACvB,uBAAuB;IACvB,SAAS;IACT,WAAW;;IAEX;MACE,gBAAgB;MAChB,cAAc;MACd,sBAAsB;MACtB,2BAA2B;MAC3B,6CAA6C;MAC7C,WAAW;MACX,gBAAgB;MAChB,aAAa;MACb,qBAAqB;MACrB,8BAA8B;MAC9B,YAAY;;MAEZ;QACE,eAAe;MACjB;;MAEA;QACE,iBAAiB;MACnB;;MAEA;;;QAGE,iBAAiB;MACnB;;MAEA;QACE,iBAAiB;MACnB;;MAEA;QACE,cAAc;QACd,WAAW;QACX,YAAY;QACZ,2BAA2B;MAC7B;;MAEA;QACE,YAAY;MACd;IACF;;IAEA;MACE,mBAAmB;MACnB,MAAM;;MAEN;QACE,gBAAgB;MAClB;IACF;;IAEA;MACE,YAAY;MACZ,UAAU;IACZ;;IAEA;MACE,yBAAyB;MACzB,iBAAiB;IACnB;;IAEA;MACE,kBAAkB;MAClB,SAAS;MACT,QAAQ;IACV;EACF;;EAEA;IACE,sBAAsB;IACtB,mBAAmB;IACnB,eAAe;EACjB;;EAEA;IACE,4BAA4B;EAC9B;;EAEA;IACE,YAAY;IACZ,gBAAgB;IAChB,gBAAgB;IAChB,kBAAkB;IAClB,MAAM;IACN,QAAQ;IACR,yBAAyB;;IAEzB;MACE,eAAe;IACjB;EACF;AACF","sourcesContent":["#menu-drawer {\n  background: rgba(227, 232, 235, 0.8);\n  transform-origin: top center;\n  transition: transform 0.5s ease-in-out;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: flex-start;\n  padding: 2.5rem;\n  overflow: hidden;\n}\n\n#menu {\n  min-width: max(300px, 50%);\n  max-width: 1100px;\n  max-height: 100%;\n  background: white;\n  color: black;\n  padding: 1rem;\n  border-radius: 2px;\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  position: relative;\n  overflow: hidden;\n\n  header {\n    position: relative;\n    width: 100%;\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n\n    h2 {\n      font-size: 1.5rem;\n      font-weight: 200;\n      letter-spacing: 0.7rem;\n      line-height: 1.4;\n      text-align: center;\n      margin: 1rem 0;\n    }\n  }\n\n  form {\n    position: relative;\n    display: flex;\n    align-content: flex-end;\n    justify-content: center;\n    gap: 2rem;\n    width: 100%;\n\n    [class$='group'] {\n      --default: black;\n      --invalid: red;\n      --isValid-color: black;\n      color: var(--isValid-color);\n      border-bottom: 2px solid var(--isValid-color);\n      width: 100%;\n      max-width: 30rem;\n      display: flex;\n      align-items: flex-end;\n      justify-content: space-between;\n      gap: 0.25rem;\n\n      & > * {\n        margin: 0.25rem;\n      }\n\n      span {\n        margin: 0.25rem 0;\n      }\n\n      label,\n      legend,\n      span {\n        text-wrap: nowrap;\n      }\n\n      legend {\n        font-weight: bold;\n      }\n\n      input {\n        height: 1.5rem;\n        width: 100%;\n        border: none;\n        color: var(--isValid-color);\n      }\n\n      select {\n        border: none;\n      }\n    }\n\n    .radio-input-group {\n      align-items: center;\n      gap: 0;\n\n      label {\n        margin-left: 1em;\n      }\n    }\n\n    fieldset {\n      border: none;\n      padding: 0;\n    }\n\n    button {\n      text-transform: uppercase;\n      text-wrap: nowrap;\n    }\n\n    #login-submit-btn {\n      position: absolute;\n      bottom: 0;\n      right: 0;\n    }\n  }\n\n  #login-form {\n    flex-direction: column;\n    align-items: center;\n    padding: 4rem 0;\n  }\n\n  #check-dates-form {\n    min-width: min(95vw, 1100px);\n  }\n\n  button.close {\n    color: black;\n    font-weight: 700;\n    font-size: 0.8em;\n    position: absolute;\n    top: 0;\n    right: 0;\n    text-transform: uppercase;\n\n    &:hover {\n      cursor: pointer;\n    }\n  }\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_cssWithMappingToString_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root {\n  --offwhite: #e3e8eb;\n}\n", "",{"version":3,"sources":["webpack://./src/css/variables.css"],"names":[],"mappings":"AAAA;EACE,mBAAmB;AACrB","sourcesContent":[":root {\n  --offwhite: #e3e8eb;\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("images/stock-hotel-1.jpg");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("images/stock-hotel-2.jpg");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("images/stock-hotel-3.jpg");
...
/* harmony export */ });
/* harmony import */ var _bookings__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(26);
/* harmony import */ var _utility__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(28);
...
/* harmony export */ });
/* harmony import */ var _customers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(27);
/* harmony import */ var _utility__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(28);
/* harmony import */ var _rooms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(25);
...
/* harmony export */ });
/* harmony import */ var _rooms__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(25);
...
/* harmony export */ });
/* harmony import */ var _data__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(30);
/* harmony import */ var _rooms__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(25);
/* harmony import */ var _uiComponents_roomCards__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(31);
/* harmony import */ var _utility__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(28);
...
const imageURLs = images.map(image => baseURL + image + urlParams);
...
/* harmony export */ });
/* harmony import */ var _domUpdates__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(29);
...
/* harmony export */ });
/* harmony import */ var _buttons__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(32);
/* harmony import */ var _domUpdates__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(29);
...
/* harmony import */ var _images_upTriangle_svg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(18);
/* harmony import */ var _images_github_png__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(19);
/* harmony import */ var _images_linkedin_png__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(20);
/* harmony import */ var _images_tech_png__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(21);
/* harmony import */ var _images_stock_hotel_1_jpg__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(22);
/* harmony import */ var _images_stock_hotel_2_jpg__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(23);
/* harmony import */ var _images_stock_hotel_3_jpg__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(24);
/* harmony import */ var _rooms__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(25);
/* harmony import */ var _bookings__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(26);
/* harmony import */ var _domUpdates__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(29);
/* harmony import */ var _uiComponents_buttons__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(32);
/* harmony import */ var _uiComponents_menu__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(33);
/* harmony import */ var _apiCalls__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(34);
/* harmony import */ var _utility__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(28);
...
var filterDefaults = {
  date: (0,_utility__WEBPACK_IMPORTED_MODULE_14__.getCurrentDate)().replaceAll('-', '/'),
  roomType: '',
  bedSize: '',
};
...
//- menu functions -//
var menu = (0,_uiComponents_menu__WEBPACK_IMPORTED_MODULE_12__.createMenu)();
...
loginBtn.onclick = () => {
  menuContent.innerHTML = '';
  hideCloseMenuBtns();
  (0,_domUpdates__WEBPACK_IMPORTED_MODULE_10__.openMenu)('login');
};
...
menuBtnGroups.forEach(
  buttonGrp =>
    (buttonGrp.onclick = e => {
      ...
      if (clickedBtn) {
        const otherBtn = (0,_uiComponents_buttons__WEBPACK_IMPORTED_MODULE_11__.getComplimentaryBtn)(clickedBtn);
        const { id } = clickedBtn;
        if (id.includes('open')) {
          const [menuType, data] = getMenuTypeAndData(id);
          (0,_domUpdates__WEBPACK_IMPORTED_MODULE_10__.openMenu)(menuType, data, user);
        } else (0,_domUpdates__WEBPACK_IMPORTED_MODULE_10__.closeMenu)(clickedBtn);
...
closeFormBtns.forEach(
  button =>
    (button.onclick = e => {
      ...
      (0,_domUpdates__WEBPACK_IMPORTED_MODULE_10__.hideElement)(menu);
      (0,_domUpdates__WEBPACK_IMPORTED_MODULE_10__.closeMenu)();
    })
);

altCloseBtn.onclick = () => (0,_domUpdates__WEBPACK_IMPORTED_MODULE_10__.hideElement)(menuDrawer, 'minimized');
//- check dates form event listeners-//
checkDatesForm.oninput = e => {
  const { id, value } = e.target;
  roomFilters = (0,_rooms__WEBPACK_IMPORTED_MODULE_8__.updateRoomFilterOptions)(id, value, roomFilters);
  filteredRooms = (0,_rooms__WEBPACK_IMPORTED_MODULE_8__.filterRooms)(roomFilters, allRooms, allBookings);
  (0,_domUpdates__WEBPACK_IMPORTED_MODULE_10__.showMenuContent)('dates', filteredRooms, user);
};
...
bookingsForm.oninput = e => {
  ...
  (0,_domUpdates__WEBPACK_IMPORTED_MODULE_10__.openMenu)('bookings', userBookings, user);
};
  ...
  if (button) {
    if (button.id.startsWith('bookit')) {
      ...
      if (value) {
        ...
        (0,_apiCalls__WEBPACK_IMPORTED_MODULE_13__.postResource)('bookings', data)
          .then(message => console.log(message))
          .then(() => (0,_apiCalls__WEBPACK_IMPORTED_MODULE_13__.getResource)('bookings'))
...
function start() {
  adjustMenuMaxHeight();
  Promise.all([(0,_apiCalls__WEBPACK_IMPORTED_MODULE_13__.getResource)('rooms'), (0,_apiCalls__WEBPACK_IMPORTED_MODULE_13__.getResource)('bookings')])
    .then(data => {
...
function updateGlobalVariables({ rooms }, { bookings }) {
  ...
  filteredRooms = (0,_rooms__WEBPACK_IMPORTED_MODULE_8__.filterRooms)(roomFilters, allRooms, allBookings);
  (0,_domUpdates__WEBPACK_IMPORTED_MODULE_10__.loadContent)(allRooms);
}
...
function loginUser() {
  ...
  (0,_domUpdates__WEBPACK_IMPORTED_MODULE_10__.toggleLoginBtns)();
...
function logoutUser() {
  ...
  (0,_domUpdates__WEBPACK_IMPORTED_MODULE_10__.toggleLoginBtns)();
  (0,_domUpdates__WEBPACK_IMPORTED_MODULE_10__.hideElement)(menuDrawer, 'minimized');
  hideCloseMenuBtns();
}

function showUserBookings(user, userBookings, allBookings, allRooms) {
  (0,_bookings__WEBPACK_IMPORTED_MODULE_9__.updateUserBookings)(user, userBookings, allBookings, allRooms);

  (0,_domUpdates__WEBPACK_IMPORTED_MODULE_10__.hideElement)(menuDrawer, 'minimized');
  hideCloseMenuBtns();
  setTimeout(() => {
    const closeBookingsBtn = (0,_uiComponents_buttons__WEBPACK_IMPORTED_MODULE_11__.getComplimentaryBtn)(openBookingsBtn);
    (0,_domUpdates__WEBPACK_IMPORTED_MODULE_10__.openMenu)('bookings', userBookings, user);
...
function validateLoginInfo(username, password) {
  if (username === 'manager' && password === 'overlook2021') {
    ...
    (0,_apiCalls__WEBPACK_IMPORTED_MODULE_13__.getResource)('customers', 50)
      .then(customer => {
        user = customer;
        loginUser();
      })
